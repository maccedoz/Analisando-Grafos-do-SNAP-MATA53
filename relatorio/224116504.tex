...
\begin{equation}
    f(M) = (S(M) \times (U(M) + 1)) \bmod 129
\end{equation}
onde $S(M)$ é a soma dos dígitos de $M$ e $U(M)$ são os dois últimos dígitos de $M$. Para a matrícula em questão, os parâmetros e a função de mapeamento são computados como segue:
\begin{align}
    S(224116504) &= 2+2+4+1+1+6+5+0+4 = 25 \\
    U(224116504) &= 04 = 4 \\
    f(224116504) &= (25 \times (4 + 1)) \bmod 129 \nonumber \\
    &= 125 \bmod 129 = 125
\end{align}
